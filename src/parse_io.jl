...
function _process_iobuff_parse!(res::Vector{<:AbstractVector},
    buffer::LineBuffer,
    ...
    df::Union{Nothing, Vector{<:DateFormat}},
    ...
    track_problems_1::BitVector,
    track_problems_2::Vector{UnitRange{Int}},
    total_line_skipped::Int,
    Characters_types::Union{Nothing, Vector{Int}, Set{Int}},
    TimeType_types::Union{Nothing, Vector{Int}, Set{Int}}
    )
...
function _process_iobuff_multiobs_parse!(res::Vector{<:AbstractVector},
    buffer::LineBuffer,
    types::Vector{DataType},
    dlm::Vector{UInt8},
    eol::Vector{UInt8},
